component hint = "this is the persistance implementation to persist/retrieve promotion information from database"  {
	
	function addPromotion(promotionType,promotionDescription,promotionStatus,promotionRule) returntype="ecommerce.model.promotion"   access="public" description="Adds promotion details to the DB"    {
		...
		promotion = createObject("component", "ecommerce.model.promotion" );
	...
	function getPromotions() returntype="ecommerce.model.promotion[]" access="public" {
