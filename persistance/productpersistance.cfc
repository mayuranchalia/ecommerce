component hint="This is persistance implementation to persist/retrieve product information from database" {
	
	
	function saveProduct(prdName,prdDescription,prdBrandId,prdCategoryId,prdImageLinks) returntype="ecommerce.model.product" access="public" {
	...
	function getProducts() returntype="ecommerce.model.product[]" access="public" {
	...
	function getProductsByBrand(brandIdArg) returntype="ecommerce.model.product[]" access="public" {
